...
# Load CSVs
knn_df = pd.read_csv("Team11_KNNClassifierPerformanceMetrics.csv")
nn_class_df = pd.read_csv("Team11_NeuralNetworkClassificationErrors.csv")
linreg_df = pd.read_csv("Team11_LinearRegressionErrors.csv")
nn_reg_df = pd.read_csv("Team11_NeuralNetworkRegressionErrors.csv")
